...
class TestPythonInterpreterPPO(unittest.TestCase):
    ...
    @patch("mini_trl.python_interpreter_ppo.setup")
    @patch("mini_trl.python_interpreter_ppo.PPOTrainer")
    @patch("mini_trl.python_interpreter_ppo.TextEnvironment")
    @patch("mini_trl.python_interpreter_ppo.load_tool")
    def test_main(
        self,
        mock_load_tool,
        mock_text_env,
